/**
 * Tamil Sign Language (TSL) gloss pre-processor.
 *
 * Responsibilities:
 *  1. Skip pure grammatical function words that carry no sign meaning.
 *  2. Try a direct whole-word sign lookup in the combined word map.
 *  3. Try case-suffix stripping, then re-lookup the root.
 *  4. Try verb-suffix stripping, then re-lookup the root.
 *  5. Fall back to letter-by-letter fingerspelling.
 */

// ── Function words with no direct TSL sign ───────────────────────────────────
// These particles/connectors are dropped in TSL glossing.
const FUNCTION_WORDS = new Set([
  'தான்', 'உம்', 'ஆனால்', 'அல்லது', 'மற்றும்', 'என்று', 'என்பது',
  'போன்று', 'போல', 'ஆக', 'ஆகும்', 'என', 'எனவே', 'ஆனாலும்',
  'இந்த', 'அந்த', 'அந்தந்த', 'ஒரு', 'அது', 'இது',
  'நான்', 'நீங்கள்', 'அவன்', 'அவள்', 'அவர்', 'அவர்கள்', 'நாங்கள்',
